...
void GLCharacterWindow::generateGLElements()
{
    ...
    generateBoxQuad(m_glObjects, {20.0F, 80.0F}, {380.0F, 500.0F}, &m_windowGLTexture.texture, 0, m_windowGLTexture.glTextureId);
    generateBoxQuad(m_glObjects, {420.0F, 80.0F}, {360.0F, 500.0F}, &m_windowGLTexture.texture, 0, m_windowGLTexture.glTextureId);
    generateBoxQuad(m_glObjects, {125.0F, 93.0F}, {167.0F, 40.0F}, &m_windowGLTexture.texture, 17, m_windowGLTexture.glTextureId);
    generateBoxQuad(m_glObjects, {488.0F, 93.0F}, {222.0F, 40.0F}, &m_windowGLTexture.texture, 17, m_windowGLTexture.glTextureId);
