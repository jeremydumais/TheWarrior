...
void TextureListComponent::connectUIActions() {
    connect(ui.pushButtonAddTexture, &QPushButton::clicked, this, &TextureListComponent::onPushButtonAddTextureClick);
    connect(ui.pushButtonEditTexture, &QPushButton::clicked, this, &TextureListComponent::onPushButtonEditTextureClick);
    connect(ui.pushButtonDeleteTexture, &QPushButton::clicked, this, &TextureListComponent::onPushButtonDeleteTextureClick);
}
