...
TEST_F(MonsterZoneSample, OperatorEqual_WithSame_ReturnTrue) {
    const MonsterZone zone2("Test", getWhiteColor());
    ASSERT_EQ(zone, zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithSame_ReturnTrue) {
    const MonsterZone zone2("Test", getWhiteColor(), 2, 5, getTwoMonsterSample());
    ASSERT_EQ(zone, zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithDiffName_ReturnFalse) {
    const MonsterZone zone2("Test2", getWhiteColor(), 2, 5, getTwoMonsterSample());
    ASSERT_FALSE(zone == zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithDiffColor_ReturnFalse) {
    const MonsterZone zone2("Test", RGBItemColor("Black", "#000000"), 2, 5, getTwoMonsterSample());
    ASSERT_FALSE(zone == zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithDiffEncounter_ReturnFalse) {
    const MonsterZone zone2("Test1", getWhiteColor(), 1, 5, getTwoMonsterSample());
    ASSERT_FALSE(zone == zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithDiffEncounterOn_ReturnFalse) {
    const MonsterZone zone2("Test1", getWhiteColor(), 2, 6, getTwoMonsterSample());
    ASSERT_FALSE(zone == zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorEqual_WithDiffEncounters_ReturnFalse) {
    const MonsterZone zone2("Test1", getWhiteColor(), 2, 5, { });
    ASSERT_FALSE(zone == zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorNotEqual_WithSame_ReturnFalse) {
    const MonsterZone zone2("Test", getWhiteColor(), 2, 5, getTwoMonsterSample());
    ASSERT_FALSE(zone != zone2);
}
...
TEST_F(MonsterZoneWithTwoMonstersSample, OperatorNotEqual_WithDiffColor_ReturnTrue) {
    const MonsterZone zone2("Test", RGBItemColor("Black", "#000000"), 2, 5, getTwoMonsterSample());
    ASSERT_NE(zone, zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorNotEqual_WithDiffEncounter_ReturnTrue) {
    const MonsterZone zone2("Test1", getWhiteColor(), 1, 5, getTwoMonsterSample());
    ASSERT_NE(zone, zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorNotEqual_WithDiffEncounterOn_ReturnTrue) {
    const MonsterZone zone2("Test1", getWhiteColor(), 2, 6, getTwoMonsterSample());
    ASSERT_NE(zone, zone2);
}

TEST_F(MonsterZoneWithTwoMonstersSample, OperatorNotEqual_WithDiffEncounters_ReturnTrue) {
    const MonsterZone zone2("Test1", getWhiteColor(), 2, 5, { });
    ASSERT_NE(zone, zone2);
}
