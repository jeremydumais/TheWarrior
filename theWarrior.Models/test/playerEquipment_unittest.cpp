...
{
    auto swd2 = WeaponItem({"swd009", "Sword2", "tex1", 0, "", 2, 1, 1.5F, WeaponBodyPart::MainHand });
...
{
    auto swd2 = WeaponItem({"swd009", "Sword2", "tex1", 0, "", 2, 1, 1.5F, WeaponBodyPart::SecondaryHand });
...
{
    auto shd9 = ArmorItem({"shd009", "Shield9", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::SecondaryHand });
...
{
    auto hlm9 = ArmorItem({"hlm009", "Helmet2", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::Head });
...
{
    auto cht9 = ArmorItem({"cht009", "Chest2", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::UpperBody });
...
{
    auto leg9 = ArmorItem({"leg009", "Legs9", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::LowerBody });
...
{
    auto glv9 = ArmorItem({"glv009", "Gloves2", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::Hands });
...
{
    auto boo9 = ArmorItem({"boo009", "Boots2", "tex1", 0, "", 2, 1, 1.5F, ArmorBodyPart::Feet });
