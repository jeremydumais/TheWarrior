...
TEST_F(MonsterSample1, GetMaxHealth_WithMonsterSample1_Return1) {
    ASSERT_EQ(6, monster.getMaxHealth());
}
...
TEST_F(MonsterSample1, GetHealthRatio_WithMonsterSample1_Return1) {
    ASSERT_FLOAT_EQ(1.0F, monster.getHealthRatio());
}

TEST_F(MonsterSample1, GetHealthRatio_WithMonsterSample1AndHP3_Return0_5) {
    monster.setHealth(3);
    ASSERT_FLOAT_EQ(0.5F, monster.getHealthRatio());
}

TEST_F(MonsterSample1, GetHealthRatio_WithMonsterSample1AndMaxHP0_Return0) {
    monster.setMaxHealth(0);
    ASSERT_FLOAT_EQ(0.0F, monster.getHealthRatio());
}
...
TEST_F(MonsterSample1, IsDead_WithMonsterSample1_ReturnFalse) {
    ASSERT_FALSE(monster.isDead());
}

TEST_F(MonsterSample1, IsDead_WithMonsterSample1WithHP0_ReturnTrue) {
    monster.setHealth(0);
    ASSERT_TRUE(monster.isDead());
}
...
TEST_F(MonsterSample1, SetMaxHealth_With4_ReturnSuccess) {
    monster.setMaxHealth(4);
    ASSERT_EQ(4, monster.getMaxHealth());
    ASSERT_EQ(4, monster.getHealth());
}

TEST_F(MonsterSample1, SetHealth_With12_ReturnSuccessNotChanged) {
    monster.setHealth(12);
    ASSERT_EQ(6, monster.getHealth());
}

TEST_F(MonsterSample1, SetHealth_With8MaxHealth7_ReturnSuccessMaxHealth) {
    monster.setMaxHealth(7);
    monster.setHealth(8);
    ASSERT_EQ(7, monster.getHealth());
}

TEST_F(MonsterSample1, SetHealth_With4_ReturnSuccess) {
    monster.setHealth(4);
    ASSERT_EQ(4, monster.getHealth());
}
...
TEST_F(MonsterSample1, ReduceHealth_With1_ReturnSuccess) {
    monster.reduceHealth(1);
    ASSERT_EQ(5, monster.getHealth());
}

TEST_F(MonsterSample1, ReduceHealth_With6_ReturnSuccess) {
    monster.reduceHealth(6);
    ASSERT_EQ(0, monster.getHealth());
}

TEST_F(MonsterSample1, ReduceHealth_With7_ReturnSuccess) {
    monster.reduceHealth(7);
    ASSERT_EQ(0, monster.getHealth());
}
...
TEST_F(MonsterSample1, RestoreHealth_With1_ReturnSuccess) {
    monster.restoreHealth(1);
    ASSERT_EQ(6, monster.getHealth());
}

TEST_F(MonsterSample1, RestoreHealth_WithHP3AndRestore1_ReturnSuccess) {
    monster.setHealth(3);
    monster.restoreHealth(1);
    ASSERT_EQ(4, monster.getHealth());
}

TEST_F(MonsterSample1, RestoreHealth_WithHP3AndRestore3_ReturnSuccess) {
    monster.setHealth(3);
    monster.restoreHealth(3);
    ASSERT_EQ(6, monster.getHealth());
}
...
TEST_F(MonsterSample1, equalityOperator_WithDifferentMaxHealth_ReturnFalse) {
    auto info = getMonsterInfoSample1();
    info.maxHealth = 8;
    ASSERT_FALSE(monster == Monster(info));
}
...
TEST_F(MonsterSample1, equalityOperator_WithDifferentHealth_ReturnFalse) {
    auto info = getMonsterInfoSample1();
    auto monster2 = Monster(info);
    monster2.setHealth(4);
    ASSERT_FALSE(monster == monster2);
}
...
TEST_F(MonsterSample1, inequalityOperator_WithDifferentMaxHealth_ReturnTrue) {
    auto info = getMonsterInfoSample1();
    info.maxHealth = 8;
    ASSERT_NE(monster, Monster(info));
}
